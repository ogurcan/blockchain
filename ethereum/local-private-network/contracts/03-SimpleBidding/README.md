...
> This example is a continuation of the [Receiving Ethers Using a Contract](../02-ReceiveEther/README.md) example.
...
You can continue to the [MarketPlace (v01)](../04-MarketPlace-v01/README.md) contract  example.
