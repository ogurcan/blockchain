...
# [http://ethdocs.org/en/latest/network/test-networks.html#setting-up-a-local-private-testnet Setting up a local provate testnet]
# [https://github.com/ethereum/go-ethereum/wiki/JavaScript-Console#management-apis geth Management API]
# [https://ethereum.gitbooks.io/frontier-guide/content/installing_linux.html Installing and running a node]
# [https://ethereum.gitbooks.io/frontier-guide/content/connecting.html Connecting to the network]
# [https://ethereum.gitbooks.io/frontier-guide/content/netstats.html Monitoring your nodes]
# Building a private test network using geth
## [https://ethereum.gitbooks.io/frontier-guide/content/cluster.html Setting up a cluster]
...
## [https://github.com/chafey/ethereum-private-network An example by Chris Hafey]
# [https://github.com/ethereum/go-ethereum/wiki/Managing-Your-Accounts Managing Accounts]
## [https://github.com/ethereum/go-ethereum/wiki/Managing-your-accounts#creating-accounts Creating Accounts]
## [https://github.com/ethereum/go-ethereum/wiki/Managing-your-accounts#updating-an-existing-account Updating an Existing Account]
## [https://github.com/ethereum/go-ethereum/wiki/Managing-your-accounts#listing-your-current-accounts Listing Your Current Accounts]
## [https://github.com/ethereum/go-ethereum/wiki/Managing-your-accounts#checking-account-balances Checking Account Balances]
# [https://ethereum.gitbooks.io/frontier-guide/content/interfaces.html Ethereum interfaces]
# [https://github.com/ethereum/pyethapp/wiki/Code-Walkthrough Code Walktrough]
# [https://www.google.com/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=geth%20server%20example%20github Docs overview]
# [https://github.com/ethereum/go-ethereum/wiki/Installation-Instructions-for-Ubuntu geth Installation Instructions for Ubuntu]
# [https://github.com/ethereum/go-ethereum/wiki/Contract-Tutorial geth Contract Tutorial]
# [[Ethereum Test Nodes in CEA]]
# Sending a Transaction
## [https://github.com/ethereum/wiki/wiki/JavaScript-API#web3ethsendtransaction web3.eth.sendTransaction]
## [https://github.com/ethereum/go-ethereum/wiki/Management-APIs#personal_sendtransaction personal.sendTransaction]
# [http://www.ethdocs.org/ Homestead Documentation]
