...
You learned about the very basics of the contracts. Now it is time to into a bit more details. You can continue to the [Sending Ethers using Contracts](./Sending%20Ethers%20Using%20a%20Contract.md) example.
