...
> This example is a continuation of the [Setting Up a Local Private Test Network with One Node](../..//README.md) example.
...
> This contract has aldready been developed and can be found in `./contracts/01-HelloWorld/HelloWorld.sol` file. If you are only interested in the deployment and usage of the contract, you can continue from this [section](#deploying-the-contract).
...
``` js
> loadScript("contracts/01-HelloWorld/deploy.js")
null [object Object]
true
> null [object Object]
